...
@main.route('/')
def index():
    return render_template('index_.html', endpoint='.index')
...
def service():
    ...
    file = module_path.replace('/main', url_for('static', filename='text/service.md'))
    with open(file, 'r', encoding='utf8') as f:
        title = f.readline()
        content = f.read()
    return render_template('markdown_.html', title=title, content=content, endpoint='.service')
...
def about():
    module_path = os.path.dirname(__file__)
    file = module_path.replace('/main', url_for('static', filename='text/about.md'))
    with open(file, 'r', encoding='utf8') as f:
        title = f.readline()
        content = f.read()
    return render_template('markdown_.html', title=title, content=content, endpoint='.about')
...
def rebate():
    module_path = os.path.dirname(__file__)
    file = module_path.replace('/main', url_for('static', filename='text/rebate.md'))
    with open(file, 'r', encoding='utf8') as f:
        title = f.readline()
        content = f.read()
    return render_template('markdown_.html', title=title, content=content, endpoint='.rebate')
...
def group():
    module_path = os.path.dirname(__file__)
    file = module_path.replace('/main', url_for('static', filename='text/group.md'))
    with open(file, 'r', encoding='utf8') as f:
        text = f.read()
    return render_template('markdown_.html', content=text, endpoint='.group')
